    ...
    <tr>
        <td id="coauthor_container">
            <div id="coauthor_1_div">
                ...
                <textarea style="height: 30px;" class="fancy-textarea js-required" placeholder="(title, institution, etc.)" name="coauthor_1_credentials" rows="1" cols="39"><?php echo( parse_html_chars( $coauthor_1_credentials ) ); ?></textarea>
            </div>
            <div id="coauthor_2_div" class="js-hide">
                ...
                <textarea style="height: 30px;" class="fancy-textarea js-required" placeholder="(title, institution, etc.)" name="coauthor_2_credentials" rows="1" cols="39"><?php echo( parse_html_chars( $coauthor_2_credentials ) ); ?></textarea>
            </div>
            <div id="coauthor_3_div" class="js-hide">
                ...
                <textarea style="height: 30px;" class="fancy-textarea js-required" placeholder="(title, institution, etc.)" name="coauthor_3_credentials" rows="1" cols="39"><?php echo( parse_html_chars( $coauthor_3_credentials ) ); ?></textarea>
            </div>
            <div id="coauthor_4_div" class="js-hide">
                ...
                <textarea style="height: 30px;" class="fancy-textarea js-required" placeholder="(title, institution, etc.)" name="coauthor_4_credentials" rows="1" cols="39"><?php echo( parse_html_chars( $coauthor_4_credentials ) ); ?></textarea>
            </div>
        </td>
        <td valign="bottom">
