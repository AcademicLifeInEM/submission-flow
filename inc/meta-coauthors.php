    ...
    <tr>
        <td id="coauthor_container">
            <div id="coauthor_1_div">
                ...
                <label for="coauthor_1_background">Background Info</label>
                <textarea style="vertical-align: middle; padding: 3px 5px; resize: vertical; resize: vertical;" name="coauthor_1_background" rows="1" cols="30"><?php echo( parse_html_chars( $coauthor_1_background ) ); ?></textarea>
            </div>
            <div id="coauthor_2_div" class="js-hide">
                ...
                <label for="coauthor_2_background">Background Info</label>
                <textarea style="vertical-align: middle; padding: 3px 5px; resize: vertical;" name="coauthor_2_background" rows="1" cols="30"><?php echo( parse_html_chars( $coauthor_2_background ) ); ?></textarea>
            </div>
            <div id="coauthor_3_div" class="js-hide">
                ...
                <label for="coauthor_3_background">Background Info</label>
                <textarea style="vertical-align: middle; padding: 3px 5px; resize: vertical;" name="coauthor_3_background" rows="1" cols="30"><?php echo( parse_html_chars( $coauthor_3_background ) ); ?></textarea>
            </div>
            <div id="coauthor_4_div" class="js-hide">
                ...
                <label for="coauthor_4_background">Background Info</label>
                <textarea style="vertical-align: middle; padding: 3px 5px; resize: vertical;" name="coauthor_4_background" rows="1" cols="30"><?php echo( parse_html_chars( $coauthor_4_background ) ); ?></textarea>
            </div>
        </td>
        <td valign="bottom">
